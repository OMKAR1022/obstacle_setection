...
def is_object_in_zone(boxes, scores, width, height, box_width, threshold=0.7):
...
def process_frame(frame, detections):
    ...
    object_in_left, object_in_middle, object_in_right = is_object_in_zone(person_boxes, scores, width, height, box_width)
